...
public class Macerator extends AContainer implements PoweredMachine {
    ...
    protected void registerDefaultRecipes() {
        ...
        addRecipe(new ItemStack(Material.COAL_BLOCK), new CustomItemStack(Items.COAL_DUST.item(), 9));
        ...
        addRecipe(new ItemStack(Material.COAL), new CustomItemStack(Items.COAL_DUST.item(), 1));
        ...
        addRecipe(new ItemStack(Material.IRON_ORE), new CustomItemStack(SlimefunItems.IRON_DUST.item(), 2));
        addRecipe(new ItemStack(Material.COAL_ORE), new CustomItemStack(Items.COAL_DUST.item(), 2));
        addRecipe(new ItemStack(Material.LAPIS_ORE), new CustomItemStack(Items.LAPIS_DUST.item(), 2));
        addRecipe(new ItemStack(Material.GOLD_ORE), new CustomItemStack(SlimefunItems.GOLD_DUST.item(), 2));
        addRecipe(new ItemStack(Material.REDSTONE_ORE), new CustomItemStack(Items.REDSTONE_DUST.item(), 2));
        addRecipe(new ItemStack(Material.DIAMOND_ORE), new CustomItemStack(Items.DIAMOND_DUST.item(), 2));
        addRecipe(new ItemStack(Material.EMERALD_ORE), new CustomItemStack(Items.EMERALD_DUST.item(), 2));
        addRecipe(new ItemStack(Material.NETHER_QUARTZ_ORE), new CustomItemStack(Items.QUARTZ_DUST.item(), 2));

        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_16)) {
            addRecipe(new ItemStack(Material.NETHER_GOLD_ORE), new CustomItemStack(SlimefunItems.GOLD_DUST.item(), 2));
            addRecipe(new ItemStack(Material.ANCIENT_DEBRIS), new CustomItemStack(Items.ANCIENT_DEBRIS_DUST.item(), 2));
        }
